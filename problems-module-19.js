...
function upercase(name) {
    let uperfunction = name.toUpperCase()
    return uperfunction;
}
let nameInput = 'rana'
let result = upercase(nameInput)
console.log(result)
 */
...
function lowerCase(name) {
    let lowerFunc = name.toLowerCase()
    return lowerFunc
}
let inputName = 'RANA'
let result = lowerCase(inputName)
console.log(result) */
...
/* 
function fullName(rana, saha) {
    let name = rana + saha
    return name
}
var result = fullName('Rana ', 'saha')
console.log(result)
 */

// ৪. একটা ফাংশন লিখবা যেটাকে তুমি কোন সংখ্যাকে ইনপুট হিসেবে দিলে সে সেই সংখ্যার square করে সেই square কে রিটার্ন করবে।অর্থাৎ তুমি ইনপুট হিসেবে 5 দিলে সেটাতে স্কয়ারে হিসেবে 25 আউটপুট 
/* function squareNum(number) {
    let sqrFormula = Math.pow(number, 2)
    return sqrFormula
}
let inputNum = 6
let result = squareNum(inputNum)
console.log(result) */
